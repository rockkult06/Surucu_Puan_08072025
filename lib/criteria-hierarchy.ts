...
export const criteriaHierarchy: Record<string, Criterion> = {
  ...
  accident: {
    id: "accident",
    name: "Çalışılan Saate Göre Kaza Durumu (Atölye Dışı)",
    level: 2,
    parentId: "admin",
    children: ["fatal_accident", "injury_accident", "material_damage_accident"],
    isLeaf: false,
    type: "cost",
    description: "Sürücünün çalıştığı saate oranla karıştığı kaza sayısı ve türü",
  },
  discipline: {
    id: "discipline",
    name: "Çalışılan Saate Göre Disiplin Durumu",
    level: 2,
    parentId: "admin",
    children: [
    ...
    isLeaf: false,
    type: "cost",
    description: "Sürücünün çalıştığı saate oranla aldığı disiplin cezalarının derecesi",
  },
  ...
  first_degree_dismissal: {
    ...
    name: "1'nci Derece Disiplin İhlallerinden Sevk Sayısı Çalışılan Saate Oranı",
    level: 3,
    parentId: "discipline",
    children: [],
    isLeaf: true,
    type: "cost",
    description: "En hafif disiplin ihlallerinin sıklığı",
    excelAliases: ["1'nci Derece Disiplin İhlallerinden Sevk Sayısı Kilometreye Oranı"],
  },
  second_degree_dismissal: {
    id: "second_degree_dismissal",
    name: "2'nci Derece Disiplin İhlallerinden Sevk Sayısı Çalışılan Saate Oranı",
    level: 3,
    parentId: "discipline",
    children: [],
    isLeaf: true,
    type: "cost",
    description: "Orta derece disiplin ihlallerinin sıklığı",
    excelAliases: ["2'nci Derece Disiplin İhlallerinden Sevk Sayısı Kilometreye Oranı"],
  },
  third_degree_dismissal: {
    id: "third_degree_dismissal",
    name: "3'ncü Derece Disiplin İhlallerinden Sevk Sayısı Çalışılan Saate Oranı",
    level: 3,
    parentId: "discipline",
    children: [],
    isLeaf: true,
    type: "cost",
    description: "Ağır disiplin ihlallerinin sıklığı",
    excelAliases: [
  ...
  fourth_degree_dismissal: {
    ...
    name: "4'ncü Derece Disiplin İhlallerinden Sevk Sayısı Çalışılan Saate Oranı",
    level: 3,
    parentId: "discipline",
    children: [],
    isLeaf: true,
    type: "cost",
    description: "En ağır disiplin ihlallerinin sıklığı",
    excelAliases: [
